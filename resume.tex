...
\textbf{IEEE CSTR SAC} \hfill Project Team Member \hfill 2025--Present
\begin{itemize}[leftmargin=*,noitemsep,topsep=0pt]
    \item Contributed to a student-led project team under IEEE, focusing on collaboration and technical development.
\end{itemize}

\textbf{Developer Community} \hfill Active Contributor \hfill 2025--Present
\begin{itemize}[leftmargin=*,noitemsep,topsep=0pt]
    \item Organized backend-focused events and guided peers in building mini backend projects.
\end{itemize}
\end{document}
